...
<!DOCTYPE html>
<html lang="id">
<?= renderAdminHead('Data Pemilih - E-Voting', '<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>') ?>
<body class="bg-slate-50">
    <div class="flex h-screen overflow-hidden">
        <?= renderAdminSidebar('voters', $_SESSION['admin_nama'] ?? 'Administrator') ?>
